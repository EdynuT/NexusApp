    ...
    return (
        <div className="player-sheet">
            ...
            <section>
                ...
                <div>Race: ____________</div>
                <div>Class: ____________</div>
                <div>Origin: ____________</div>
                <div>Level: ____________</div>
                <div>Language: ____________</div>
                <div>Clothing: ____________</div>
                <div>Appearance: ____________</div>
                <div>Age: ____________</div>
            </section>

            <section>
                <h2>Economy</h2>
                <div>Gold Coins: ____________</div>
            </section>

            <section>
                <h2>Base Stats</h2>
                <div>Health: ____________</div>
                <div>Mana: ____________</div>
                <div>Sanity: ____________</div>
                <div>Stamina: ____________</div>
            </section>
